...
public final class ShooterMath {
     ...
     *
     * This is the angle the robot should face to be pointed at the hub.
     * Uses atan2 to compute the field-frame angle.
     *
     * @param robotPose current field-relative robot pose
    ...
    /**
     * Memoized supplier that caches the setpoint and only recomputes when the
     * pose timestamp changes (i.e., once per robot loop iteration).
     */
