...
public class AlignToAprilTag extends Command {
  ...
  DoubleSupplier rotInputSupplier;
  ...
  public AlignToAprilTag(
      CommandSwerveDrivetrain drivetrain, VisionSubsystem vision, AlignPosition alignPosition, DoubleSupplier yInputSupplier, DoubleSupplier rotInputSupplier) {
    ...
    this.rotInputSupplier = rotInputSupplier;
  ...
  public void initialize() {
    ...
    targetPose = new Pose2d(
        AprilTagMaps.aprilTagMap.get(6).getX(),
  ...
  public void execute() {
    ...
    drivetrain.setControl(driveRequest
        ...
        .withVelocityY(xInputSupplier.get())
        .withRotationalRate(rotInputSupplier.get());
  }
