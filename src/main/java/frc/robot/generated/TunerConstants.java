...
public class TunerConstants {
  ...
  // Pure P control for steer - no D term prevents oscillation
  ...
  // Pure feedforward for drive - kP=0 for smoother velocity control
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0).withKI(0).withKD(0).withKS(0).withKV(0.124);
  ...
  private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
      .withCurrentLimits(new CurrentLimitsConfigs()
          // Current limits for steer motors - prevents brownouts
          .withSupplyCurrentLimitEnable(true)
          .withStatorCurrentLimitEnable(true)
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.42919921875);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.26708984375);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.273681640625);
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.039794921875);
