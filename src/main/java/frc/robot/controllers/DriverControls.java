 ...
 * {@link Superstructure} so it can coordinate subsystems. Drivetrain commands
 * (heading lock, brake,
 * vision align) remain direct since the Superstructure does not manage the
 * drivetrain.
 */
public final class DriverControls {
     ...
     * @param stateMachine     global robot state machine (for fuel feedback
     *                         triggers)
    ...
    public static void configure(
        ...
        Supplier<Double> translationY = () -> invertTranslation[0] ? -controller.getLeftY() : controller.getLeftY();
        Supplier<Double> translationX = () -> invertTranslation[0] ? -controller.getLeftX() : controller.getLeftX();
        ...
        new Trigger(() -> superstructure.getCurrentSuperState() == Superstructure.CurrentSuperState.FORCE_SHOOTING
        ...
        controller
                ...
                .onFalse(Commands.sequence(
                        Commands.runOnce(() -> superstructure.getShooterPivot().setTrenchAutoLowerEnabled(true)),
