...
| Fish | [@sockeye-d](https://github.com/sockeye-d) | **Code Quality**: Cleaned up the pivot subsystem and migrated it to WPILib type-safe units, eliminating a class of unit-mismatch bugs (rotations vs. degrees vs. radians) at the subsystem interface. Applied the same units-first cleanup to the shooter subsystem. |
